...
con.connect(function(err) {
    if (err) throw err;
    con.query(
  //  "SELECT drug_name FROM drugtab WHERE drug_name = 'Cephalexin' UNION ALL SELECT drug_name FROM drugtab2 WHERE drug_name = 'Cephalexin'"
   "SELECT drug_name FROM drugtab WHERE EXISTS (SELECT drug_name WHERE drug_name = 'Cephalexin');"
  ...
  // SELECT drugtab.drug_name, drugtab2.drug_name FROM drugtab , drugtab2 WHERE  drugtab2.drug_name ='Parasitamol'